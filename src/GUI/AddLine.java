...
public class AddLine extends javax.swing.JFrame {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        String filePath = "src\\Database\\order.txt"; // Replace with your file path
        String address = "d";
        String contact = "0";
        String username = "Jon";
        ...
        try {
            ...
            String lineToAdd = Order.getTotalOrders() + ", " + username + ", " + address + ", " + contact + ", pending, " + Runner.getNextRunner(orderList) + ", " + newDate + ", 5.0";
